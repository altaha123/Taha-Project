...
(function () {
  ...
  var CSS = [
    ...
    '  margin:0 0 22px}',
    '.hzswitch .hzlbl{font-family:var(--mono);font-size:11px;letter-spacing:.12em;',
    ...
    '  padding:7px 15px;font-family:var(--mono);font-size:12px;letter-spacing:.06em;',
    ...
    '.hzhint{font-size:13px;color:var(--mute);flex:1;min-width:200px;',
    '  line-height:1.5}',
    ...
    '.sched-v3 .v3cell .lbl{font-family:var(--mono);font-size:10px;',
    '  letter-spacing:.1em;text-transform:uppercase;color:var(--mute)}',
    '.sched-v3 .v3cell .num{font-family:var(--serif);font-size:28px;line-height:1;',
    ...
    '.whytitle .wk{font-family:var(--mono);font-size:10px;letter-spacing:.11em;',
    '  text-transform:uppercase;color:var(--mute)}',
    '.whytitle .wv{font-family:var(--serif);font-size:24px;line-height:1.15;',
    '  color:var(--ink)}',
    '.whytitle .wv.conf-ok{color:var(--pass)}',
    '.whytitle .wv.conf-mid{color:var(--gold-dp,var(--gold))}',
    '.whytitle .wv.conf-low{color:var(--fail)}',
    '.whytitle .wsub{font-size:13px;color:var(--mute);line-height:1.5}',
    '.whymatters{font-size:16px;line-height:1.62;color:var(--ink-2);',
    '  max-width:70ch;margin:0 0 14px}',
    '.whycycle,.whynote,.whymissing{font-size:14px;line-height:1.6;',
    '  color:var(--ink-2);max-width:70ch;margin:0 0 12px;padding-left:14px;',
    '  border-left:2px solid var(--gold-line)}',
    '.whysrc{font-family:var(--mono);font-size:11px;color:var(--mute);',
    ...
    '  font-size:12px;letter-spacing:.04em;color:var(--ink-2);list-style:none}',
